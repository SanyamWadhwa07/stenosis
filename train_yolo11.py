"""
Train YOLO11m on the stenosis detection dataset.
...
# Paths are resolved relative to this script's location so the whole folder
# is portable — just drop the scripts next to the 'stenosis/' data directory.
